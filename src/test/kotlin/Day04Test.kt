...
class Day04Test {
    ...
    fun testSampleInputPart1() {
        val actual = Day04.part1(sample)
        assertEquals(4512, actual)
    }

    @Test
    fun testPuzzleInputPart1() {
        val solution = Day04.part1(puzzleInput)
        assertEquals(6592, solution)
    }

    @Test
    fun testSampleInputPart2() {
        val actual = Day04.part2(sample)
        assertEquals(1924, actual)
    }

    @Test
    fun testPuzzleInputPart2() {
        val solution = Day04.part2(puzzleInput)
        assertEquals(31755, solution)
    }
}